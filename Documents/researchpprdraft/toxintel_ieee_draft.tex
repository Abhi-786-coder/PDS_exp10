...
toxic minority class and predicts inefficacy of ADASYN oversampling in embedding space.
...
Hyperparameters were optimized via Optuna search (up to 200 trials) with a
cosine annealing schedule and early stopping at 10 stagnant trials (patience=15).
...
Candidates are filtered for synthesizability (SAScore\,$<$\,4.5 and SCScore\,$<$\,4.0, using RDKit and SCScore implementations) and ADME preservation
($|\Delta\text{LogP}| < 1.5$, $|\Delta\text{MW}| < 80$\,Da).
